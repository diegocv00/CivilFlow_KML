...
.dhidrosan-wrapper{
  ...
  --acc:#00f5ff;--acc2:#00dce5;--acc3:#00696e;--glow:rgba(0,245,255,.3);
...
.ntab{display:flex;flex:1;align-items:center;justify-content:center;gap:6px;padding:9px 13px;font-size:11px;font-weight:500;color:var(--txt3);cursor:pointer;border-bottom:2px solid transparent;white-space:nowrap;transition:all .15s;font-family:var(--body)}
...
.nbadge{font-family:var(--mono);font-size:8px;padding:1px 5px;border-radius:10px;background:var(--bg4);color:var(--txt3)}
.ntab.on .nbadge{background:var(--acc3);color:#fff}
.ntab.gas-tab.on .nbadge{background:var(--gas-bg);color:var(--gas)}
.layout{display:flex;flex:1;overflow:hidden}
.sb{width:278px;flex-shrink:0;background:var(--bg2);border-right:1px solid var(--line);overflow-y:auto;display:flex;flex-direction:column}
.sb-sec{padding:13px 14px;border-bottom:1px solid var(--line)}
.sb-hdr{font-family:var(--mono);font-size:8px;font-weight:600;letter-spacing:1.4px;text-transform:uppercase;color:var(--txt3);margin-bottom:9px;display:flex;align-items:center;gap:6px}
.sb-hdr::after{content:'';flex:1;height:1px;background:var(--line)}
.f{margin-bottom:8px}.f label{display:block;font-size:10px;font-weight:500;color:var(--txt2);margin-bottom:2px}
.f input,.f select{width:100%;padding:5px 8px;background:var(--bg3);border:1px solid var(--line);border-radius:var(--r);font-size:11px;font-family:var(--mono);color:var(--txt);outline:none;transition:border .15s}
...
.tg.on{border-color:rgba(0,245,255,.4);background:rgba(0,245,255,.06)}
...
.tg-nm{font-size:10px;font-weight:500;color:var(--txt2)}.tg-sb{font-size:8px;color:var(--txt3);font-family:var(--mono)}
...
.piso-tag{font-family:var(--mono);font-size:8px;background:var(--bg4);color:var(--txt2);padding:2px 6px;border-radius:4px;white-space:nowrap;min-width:72px;text-align:center}
...
.npt-in{width:52px;padding:3px 5px;background:var(--bg);border:1px solid var(--line);border-radius:4px;font-family:var(--mono);font-size:9px;color:var(--txt);outline:none;text-align:right}
.pdot{width:6px;height:6px;border-radius:50%;background:var(--line2);flex-shrink:0;margin-left:auto}
.pdot.ok{background:var(--ok)}
.btn-xs{padding:4px 10px;border:1px dashed var(--line2);border-radius:var(--r);background:transparent;color:var(--txt3);font-size:9px;cursor:pointer;width:100%;font-family:var(--body);transition:all .15s;margin-top:3px}
...
.card-t{font-family:var(--body);font-size:12px;font-weight:600;display:flex;align-items:center;gap:7px}
.card-s{font-size:9px;color:var(--txt3);font-family:var(--mono)}.card-b{padding:13px}
...
.dz:hover,.dz.drag{border-color:var(--acc2);background:rgba(0,245,255,.04)}
...
.pill{font-family:var(--mono);font-size:8px;padding:2px 6px;border-radius:20px;background:var(--bg4);color:var(--txt3);border:1px solid var(--line2)}
.tbl{width:100%;border-collapse:collapse;font-size:11px}
.tbl th{padding:5px 8px;background:var(--bg3);color:var(--txt3);font-family:var(--mono);font-size:8px;font-weight:600;letter-spacing:.4px;text-transform:uppercase;text-align:left;border-bottom:1px solid var(--line);white-space:nowrap}
.tbl th.c{text-align:center}.tbl td{padding:4px 7px;border-bottom:1px solid var(--line);vertical-align:middle}
.tbl tr:last-child td{border-bottom:none}.tbl tr:hover td{background:rgba(255,255,255,.01)}
.tbl-sec td{padding:3px 8px;background:var(--bg);font-family:var(--mono);font-size:8px;font-weight:600;letter-spacing:.8px;text-transform:uppercase;color:var(--txt3);border-bottom:1px solid var(--line)}
.col-h{padding:3px 8px;font-family:var(--mono);font-size:8px;font-weight:600;letter-spacing:.4px;text-transform:uppercase;text-align:center}
...
.sigla{font-family:var(--mono);font-size:9px;font-weight:600;color:var(--acc2);background:rgba(0,245,255,.12);padding:2px 6px;border-radius:3px;display:inline-block}
.sigla.gas{color:var(--gas);background:var(--gas-bg)}.ap-nm{font-weight:500;color:var(--txt);font-size:11px}
.ap-ref{font-family:var(--mono);font-size:8px;color:var(--txt3)}
.ni{width:100%;padding:3px 6px;background:var(--bg);border:1px solid var(--line);border-radius:4px;font-family:var(--mono);font-size:9px;color:var(--txt);text-align:center;outline:none;transition:border .12s}
.ni:focus{border-color:var(--acc2)}.ni.g{border-color:var(--gas-b)}.ni.g:focus{border-color:var(--gas)}
.badge{display:inline-flex;align-items:center;justify-content:center;min-width:28px;padding:1px 6px;border-radius:20px;font-family:var(--mono);font-size:9px;font-weight:500}
...
.tot-l{font-family:var(--mono);font-size:8px;color:var(--txt3);margin-bottom:2px;text-transform:uppercase}
...
.tot-s{font-family:var(--mono);font-size:8px;color:var(--txt3);margin-top:1px}
.tramo-card{background:var(--bg3);border:1px solid var(--line);border-radius:var(--r2);margin-bottom:7px;overflow:hidden}
.tramo-hdr{display:flex;align-items:center;gap:9px;padding:7px 11px;background:var(--bg4);border-bottom:1px solid var(--line)}
.tramo-id{font-family:var(--mono);font-size:10px;font-weight:600;color:var(--gas);background:var(--gas-bg);padding:2px 7px;border-radius:4px}
...
.tramo-lbl{font-family:var(--mono);font-size:8px;color:var(--txt3);text-transform:uppercase;letter-spacing:.4px}
...
.chk-item{display:flex;align-items:center;gap:4px;font-family:var(--mono);font-size:9px}
...
.cal-marca{font-family:var(--mono);font-size:8px;color:var(--txt3);text-transform:uppercase;margin-bottom:3px}
.cal-ref{font-size:11px;font-weight:600;color:var(--txt);margin-bottom:5px}
.cal-vals{display:flex;gap:7px;flex-wrap:wrap}.cal-val{font-family:var(--mono);font-size:9px}.cal-val span{color:var(--gas)}
.ib{padding:9px 12px;border-radius:var(--r2);font-size:11px;line-height:1.6;display:flex;gap:9px}
...
.ib.info{background:var(--af-bg);border:1px solid rgba(0,245,255,.2);color:var(--acc2)}
.ib.err{background:var(--err-bg);border:1px solid var(--err-b);color:var(--err)}
.val-r{display:flex;align-items:flex-start;gap:9px;padding:8px 11px;border-radius:var(--r);margin-bottom:4px;font-size:11px}
...
.meta-l{font-family:var(--mono);font-size:8px;color:var(--txt3);margin-bottom:3px;text-transform:uppercase}
.meta-v{font-family:var(--head);font-size:18px;letter-spacing:.5px;color:var(--txt)}
.meta-s{font-family:var(--mono);font-size:8px;color:var(--acc2);margin-top:2px}
.res-row{display:flex;gap:10px;align-items:baseline;padding:5px 9px;background:var(--bg3);border-radius:var(--r);border:1px solid var(--line);margin-bottom:4px}
.res-k{font-family:var(--mono);font-size:8px;color:var(--txt3);min-width:130px;flex-shrink:0;text-transform:uppercase}
.res-v{font-size:11px;color:var(--txt);font-weight:500}
...
.pres-niv{font-size:10px;font-weight:500;color:var(--txt);margin-bottom:5px}
.pres-val{display:flex;justify-content:space-between;font-family:var(--mono);font-size:9px;margin-bottom:2px}
...
.nli{display:flex;align-items:center;gap:5px;font-family:var(--mono);font-size:8px;color:var(--txt3)}
...
.act-info{font-family:var(--mono);font-size:9px;color:var(--txt3)}.btn-g{display:flex;gap:7px}
    ...
    <div className="dhidrosan-wrapper" style={{height:'100%',display:'flex',flexDirection:'column',overflow:'hidden'}}>
      ...
      <div className="app">
        ...
        <div className="layout">
          ...
          {/* ══ SIDEBAR ══ */}
          <div className="sb" style={{width:sidebarOpen?278:0,minWidth:0,transition:'width .2s',flexShrink:0}}>
          {sidebarOpen&&(<div style={{minWidth:278,height:'100%',display:'flex',flexDirection:'column',overflow:'hidden auto'}}>
          <div style={{display:'flex',justifyContent:'flex-end',padding:'6px 8px',borderBottom:'1px solid var(--line)',background:'var(--bg2)'}}>
            <span onClick={()=>setSidebarOpen(false)} style={{cursor:'pointer',fontSize:'11px',color:'var(--txt3)',fontFamily:'var(--mono)',letterSpacing:'1px'}}>✕ CERRAR</span>
          </div>
            ...
            <div className="sb-sec">
              ...
              <div style={{background:'var(--bg)',border:'1px solid rgba(0,245,255,.25)',borderRadius:'var(--r)',padding:'9px',marginBottom:8}}>
                <div style={{fontFamily:'var(--mono)',fontSize:8,color:'var(--acc2)',marginBottom:8,textTransform:'uppercase',fontWeight:600}}>⚡ Generador</div>
